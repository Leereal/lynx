    ...
    <div class="xl:w-1/2 md:w-3/4 w-full m-8 whitespace-nowrap">
      <div class="flex bg-white overflow-hidden rounded-xl">
        <div class="w-1/2 lg:block hidden p-2">
          <img
            src="assets/images/bg-auth-2.png"
            alt=""
          ...
          <div class="px-6 py-8">
            <div class="flex justify-between items-start">
              ...
              <a href="#" class="flex mb-6">
                <span
                  class="font-extrabold text-2xl first-letter:text-sky-500 tracking-wider"
                  >Plug<span class="text-sky-500">.</span>Auth</span
                >
              </a>
            </div>
            ...
            <div class="mb-4">
              <label
                class="flex font-semibold text-base mb-2"
                for="EmailAddress"
                >Email Address</label
              >
              <input
            ...
            <div class="mb-4">
              <label class="flex font-semibold text-base mb-2" for="Password"
                >Password</label
              >
              <input
                id="Password"
            ...
            <div class="flex items-center justify-between mb-4">
              <div class="flex items-center">
                ...
                />
                <label
                  class="ms-2 inline-block text-sm font-semibold cursor-pointer text-gray-600"
                  for="checkbox-signin"
                  >Remember me</label
                >
              </div>
              <a
                ...
                class="text-sm text-sky-500 border-b border-dashed border-sky-500"
                >Forget Password ?</a
              >
            </div>
            ...
            <div class="flex items-center my-6">
              <div
                class="flex-auto mt-px border-t border-dashed border-gray-200"
              ></div>
